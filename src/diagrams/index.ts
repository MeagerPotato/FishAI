...
export { AdaptiveMechanism } from './AdaptiveMechanism'
...
export { layoutAdaptiveMechanism } from './layout/adaptiveMechanism'
export type { AdaptiveMechanismModel } from './layout/adaptiveMechanism'
