...
v0.20b, v0.22--v0.27 & the closing family, every rung and dose, one and two at a time & stopped at home: the shipped point is a local optimum on every axis \\
\midrule
...
\end{itemize}
The record keeps the reader's line verbatim and scores condition 5 as registered; the owner may hold
v1.0 to the reader's line instead, and the record says so.
