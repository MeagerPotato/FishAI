...
| even sets: the side that reaches four first (A starts / B starts) | **48.4% / 49.2%** | **48.7% / 48.3%** |
...
8 to 9 points more often — and buys nothing underneath: **the side reaches four first no more
often** (48.4% against 49.2%, 48.7% against 48.3%), the chases it buys **hit two points less**,
...
−0.8 and +0.4 against +2 to +6; the chase share at lead decisions +1.4 and +2.2 against the
